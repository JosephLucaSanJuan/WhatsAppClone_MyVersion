...
class ContactListAdapter(private val toChat: (View, Contact) -> Unit):
    ListAdapter<Contact, ContactListAdapter.ContactListItemViewHolder>(ContactDiff) {
    inner class ContactListItemViewHolder(private val binding:ContactListItemBinding): RecyclerView.ViewHolder(binding.root) {
